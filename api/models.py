...
class Coach(Base):
    """
    Classe représentant la table 'Coach'.
    """
    __tablename__ = "Coach"
...
class Abonnement(Base):
    """
    Classe représentant la table 'Abonnement'.
    """
...
class Medecin(Base):
    """
    Classe représentant la table 'Médecin'.
    """
...
class Transaction(Base):
    """
    Classe représentant la table 'Transaction'.
    """
...
class Salle(Base):
    """
    Classe représentant la table 'Salle'.
    """
    __tablename__ = "Salle"
...
class Machine(Base):
    """
    Classe représentant la table 'Machine'.
    """
...
class Capteur(Base):
    """
    Classe représentant la table 'Capteur'.
    """
...
class Pays(Base):
    """
    Classe représentant la table 'Pays'.
    """
    __tablename__ = "Pays"
...
class Activite(Base):
    """
    Classe représentant la table 'Activité'.
    """
...
class Equipement(Base):
    """
    Classe représentant la table 'Équipement'.
    """
...
class Ville(Base):
    """
    Classe représentant la table 'Ville'.
    """
    __tablename__ = "Ville"
...
class Membre(Base):
    """
    Classe représentant la table 'Membre'.
    """
...
class AnalyseCorporelle(Base):
    """
    Classe représentant la table 'Analyse_Corporelle'.
    """
...
class CodePostal(Base):
    """
    Classe représentant la table 'Code_postal'.
    """
...
class Adresse(Base):
    """
    Classe représentant la table 'Adresse'.
    """
...
class Assurance(Base):
    """
    Classe représentant la table 'Assurance'.
    """
...
class Club(Base):
    """
    Classe représentant la table 'Club'.
    """
    __tablename__ = "Club"
...
class AgentSecurite(Base):
    """
    Classe représentant la table 'Agent_Sécurité'.
    """
...
class AgentNettoyage(Base):
    """
    Classe représentant la table 'Agent_Nettoyage'.
    """
...
class UtilisationMachine(Base):
    """
    Classe représentant la table 'Utilisation_Machine'.
    """
...
class Paiement(Base):
    """
    Classe représentant la table 'Paiement'.
    """
...
class Specialisation(Base):
    """
    Classe représentant la table 'Spécialisation'.
    """
...
class Pratique(Base):
    """
    Classe représentant la table 'Pratique'.
    """
...
class SalleActivite(Base):
    """
    Classe représentant la table 'Salle_Activité'.
    """
...
class ClubSalle(Base):
    """
    Classe représentant la table 'Club_Salle'.
    """
...
class Souscrit(Base):
    """
    Classe représentant la table 'souscrit'.
    """
